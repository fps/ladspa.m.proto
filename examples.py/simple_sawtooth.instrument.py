...
for n in range(number_of_voices):
	...
	make_voice_connection(instrument, n, 0, env, 1)
	make_voice_connection(instrument, n, 1, env, 0)
	make_voice_connection(instrument, n, 3, osc, 0)
